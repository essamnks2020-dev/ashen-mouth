...
export const WINDOWS = [
  ...
  { wall: 's', c: 5.08, y: 0, curtains: false, boarded: true },
  { wall: 's', c: -4.72, y: H, curtains: true },
  { wall: 's', c: -3.38, y: H, curtains: true, boarded: 3 },
  { wall: 's', c: 3.82, y: H, curtains: true },
  { wall: 's', c: 5.08, y: H, curtains: true, boarded: true },
  { wall: 'n', c: -3.55, y: 0, curtains: false, boarded: true },
  { wall: 'n', c: 3.55, y: 0, curtains: false },
  { wall: 'n', c: -3.55, y: H, curtains: true, boarded: 4 },
  { wall: 'n', c: 3.55, y: H, curtains: true },
  { wall: 'w', c: 2.70, y: 0, curtains: true },
  { wall: 'w', c: -1.85, y: 0, curtains: false, boarded: true },
  { wall: 'w', c: 2.70, y: H, curtains: true },
  { wall: 'w', c: -1.85, y: H, curtains: true, boarded: 3 },
  { wall: 'e', c: 2.55, y: 0, curtains: false, boarded: true },
